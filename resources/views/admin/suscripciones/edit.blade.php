    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Suscripción</h1>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 alert alert-info">
                            <span>Le quedan <b>{{ $dias }}</b> días de suscripción.</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5 form-group">
                            ...
                            <div wire:ignore class="form">
                                <select class="my-select" id="cliente" data-width="100%" data-live-search="true"
                                    data-size="10">
