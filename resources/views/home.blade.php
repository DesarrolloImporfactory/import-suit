        ...
        @if($suscripcion != '0' && $suscripcion->dias <= 0)
            <div class="alert alert-danger ">
                <span>¿Observa que algunas herramientas aparecen en gris y están marcadas como 'no disponibles'?
                    <button class="btn btn-sm btn-warning text-white" data-bs-toggle="modal" data-bs-target="#subscriptionExpiredModal">Averiguar ¿Por qué?</button>
                </span>
        </div>
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <hr>
                ...
                Durante el período de su suscripción, esperamos que haya disfrutado de las ventajas y beneficios exclusivos que ofrecemos. Su acceso a herramientas premium, contenido especializado y soporte prioritario ha sido suspendido temporalmente debido a la caducidad de su suscripción. <br>
                
                En ImporFactory, estamos comprometidos a ofrecer la mejor experiencia y valor a nuestros suscriptores. Renovar su suscripción no solo le permitirá recuperar el acceso inmediato a todas las herramientas y servicios que ha estado disfrutando, sino que también asegurará que continúe recibiendo las últimas actualizaciones, mejoras de seguridad y soporte exclusivo que vienen con su membresía. <br>
                
                Le invitamos cordialmente a renovar su suscripción para restablecer su acceso completo y continuar beneficiándose de las características y servicios exclusivos que ofrecemos. Si tiene alguna pregunta o necesita asistencia adicional con el proceso de renovación, no dude en contactarnos. <br>
