    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-4 col-md-4 col-lg-4 mt-2">
                @livewire('permisos.create-permiso')
            </div>
        </div>
        <div class="row">
                                        ...
                                        <td style="width: 100px;">
                                            <div class="btn-group btn-group-sm" role="group"
                                                ...
                                                <a class="btn btn-xs btn-default text-primary mx-1 shadow"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#editPermiso"><i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <a class="btn btn-xs btn-default text-danger mx-1 shadow"
                                                    wire:click="$emit('deletePermiso',{{ $item->id }})"
...
@push('js')
    <script>
        Livewire.on('deletePermiso', userId => {
            iziToast.show({
                theme: 'dark',
                icon: 'icon-person',
                title: 'Hey',
                ...
                buttons: [
                    ['<button>Ok</button>', function(instance, toast) {
                        Livewire.emitTo('permisos.permisos-table', 'delete', userId);
                    }, true], // true to focus
