<div>
    <div class="d-flex">
        <h4 class="flex-grow-1 mb-2">Actualizar producto</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <p>Precio en china:</p>
                                <input type="text" id="precio1" wire:model='price_china'
                            ...
                            <div class="form-group col-md-3">
                                <p>Precio en latam:</p>
                                <input type="text" id="precio2" wire:model='price_latam'
                                    class="form-control form-control-sm">
                                @error('price_latam')
                                    <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-3">
                                <p>P.P.M:</p>
                                <input type="text" id="precio3" wire:model='price_mayor'
                                    class="form-control form-control-sm">
                                @error('price_mayor')
                                    <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-3">
                                <p>P.V.P:</p>
                                <input type="text" id="precio4" wire:model='price_public'
                                    class="form-control form-control-sm">
                                @error('price_public')
                                    <span class="text-danger" style="font-size: 12px;">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <p>Proveedor</p>
                                    <div wire:ignore>
                                        <select class="my-select" name="" data-style="btn-warning"
                                            id="proveedorEdit" data-width="100%" title="Choose one of the following...">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control form-control-sm" wire:model='photo'>
                                    @error('photo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <p>Categoría:</p>
                                    <div wire:ignore>
                                        <select class="my-select" name="" data-width="100%"
                                            id="categoriaEdit" title="Choose one of the following...">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control form-control-sm" accept=".png, .jpg, .jpeg"
                            ...
                            <div class="form-group text-center">
                                @if ($photos)
                                    @foreach ($photos as $item)
                                        <img src="{{ $item->temporaryUrl() }}" class="img-thumbnail" width="150">
                                    @endforeach
                                @else
                                    @foreach ($files as $item)
                                        <img src="../../../storage/{{ $item->photo }}" class="img-thumbnail"
                                            width="150">
                                    @endforeach
                                @endif
